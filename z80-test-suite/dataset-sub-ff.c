/**
 * @file  dataset-sub-ff.c
 * @brief exhaust the SUB alu operations.
 *
...
void main(){
    con_init();
    con_put("Z80 SUB F=FFh Dataset\n");
    con_put("Output via Control 2 UART\n\n");
    con_put("See README.md for more info\n");
    
    /*Send header through UART*/
    print("#Hex value of AF registers after performing SUB A,B; A - B with F = 0xFF\r\n");
