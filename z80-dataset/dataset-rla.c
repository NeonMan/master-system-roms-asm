...
void main(){
    ...
    /*Send payload*/
    print("#Hex value of AF registers after performing RLA with F = 0x00\r\n");
    do_test(0x0000);
	
	print("#Hex value of AF registers after performing RLA with F = 0x00 + Carry\r\n");
    do_test(0x0001);
    
    print("#Hex value of AF registers after performing RLA with F = 0xFF\r\n");
    do_test(0x00FF);
	
	print("#Hex value of AF registers after performing RLA with F = 0xFF - Carry\r\n");
    do_test(0x00FE);
