/**
 * @file  dataset-or.c
 * @brief exhaust the OR alu operations.
 *
...
void main(){
    con_init();
    con_put("Z80 OR Dataset\n");
    con_put("Output via Control 2 UART\n\n");
    con_put("See README.md for more info\n");
    
    /*Send header through UART*/
    print("#Hex value of AF registers after performing OR A, B; A | B with F = 0x00\r\n");
    ...
    /*Send payload*/
    do_test_zero();
    print("#Hex value of AF registers after performing OR A, B; A | B with F = 0xFF\r\n");
    do_test_ones();
